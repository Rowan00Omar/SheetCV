...
export const cvData: CvData = {
  ...
  en: {
    ...
    skills: {
      title: 'Skills',
      items: [
        'Leadership Development', 'Team Management', 'Player Development', 'Sports Marketing', 
        'Contract Negotiation', 'Educational Management', 'Game Strategy Planning', 'Effective Communication'
      ]
    },
    credentials: {
      title: 'Credentials',
  ...
  ar: {
    ...
    skills: {
        title: 'المهارات',
        items: [
          'تطوير القيادة', 'إدارة الفريق', 'تطوير اللاعبين', 'التسويق الرياضي', 
          'التفاوض على العقود', 'الإدارة التعليمية', 'تخطيط استراتيجيات اللعب', 'التواصل الفعال'
        ]
    },
    credentials: {
